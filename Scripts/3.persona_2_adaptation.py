"""
This is the file for generatation of Persona 2.
The profile of this persona is the following:
* English Level: Intermediate to advanced: B2 - C1
*Art Knowledge: Deep (either an art historian, a curator, or a serious art collector)
* Vocabulary Challenge: general academic English, non-art specific terms
* Cultural Context: May miss context, English idioms, or cultural references
What case will this test:
* Selective simplification: linguistic versus domain-specific
* Preservation of disciplinary expertise signals
* Impact of syntactic simplification alone
* Whether the curatorial tone can be kept with simpler grammar
"""
...
#Loading the prompt
print("Loading Persona 2 prompt...")

with open('Prompts/persona2_prompt.txt', 'r', encoding='utf-8-sig') as f:#This is meant to load the prompt for the adaptation based on the profile of persona 2.
...
#Loading the dataset of initial curatorial texts
...
#The output paths, if such filder does not exist, one will be created
os.makedirs('Data/adapted/Persona_2', exist_ok=True)
""""
...
"""
checkpoint_path = 'Data/adapted/Persona_2/persona2_checkpoint.csv'
final_output_path = 'Data/adapted/Persona_2/persona2_adapted.csv'
failed_output_path = 'Data/adapted/Persona_2/persona2_failed_rows.csv'
failed_ids_path = 'Data/adapted/Persona_2/persona2_failed_ids.txt'


# Loading a checkpoint, if one exists
processed_ids = set()
...
Provide the adapted text for a non-native English speaker with art expertise:
"""
    ...
    try:
        ...
        messages = [
            {
                "role": "system",
                "content": "You are an expert at adapting museum texts for non-native English speakers with art knowledge."
            },
            {
                "role": "user",
                "content": full_prompt
...
print("\n" + "=" * 60)
print("PERSONA 2 ADAPTATION COMPLETE")
print("=" * 60)
...
* I belive that the failures in the first code, the lexical simplification one, were due to 
poor wifi connection
2: After the second run there were no errors.
BUT: There were no failures, but there were random characters inserted.
3: There was no longer the issue of the corrupted charcters, all of the texts were adapted 
successfully
1.1: After chaning the prompt to a more specific one,
